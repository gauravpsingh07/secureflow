  ...
  return (
    <main className="flex flex-1 items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Sign in to SecureFlow</h1>
        <p className="mt-1 text-sm text-slate-500">Access your security workspace.</p>
